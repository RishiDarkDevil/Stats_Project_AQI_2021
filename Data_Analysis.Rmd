...
```{r Station_Monthly_Viz, fig.asp=0.618, fig.width=8}
...
```{r Yearly_Pollutant_Hist_1, fig.asp=0.618, fig.width=8}
air_data_india_pollutants %>%
  filter(!(Year %in% c(2014, 2015, 2016, 2017)) & !(Specie %in% c('pm25', 'pm10'))) %>%
...
```{r Yearly_Indiv_Pollutant_Hist, fig.asp=0.618, fig.width=8}
air_data_india_pollutants %>%
  filter(!(Year %in% c(2014, 2015, 2016, 2017)) & !(Specie %in% c('pm25', 'pm10'))) %>%
...
```{r Yearly_Indiv_Pollutant_Hist_2, fig.asp=0.618, fig.width=8}
air_data_india_pollutants %>%
  filter(!(Year %in% c(2014, 2015, 2016, 2017)) & (Specie %in% c('pm25', 'pm10'))) %>%
  ggplot(aes(median, ..density.., fill = cut_width(Year,1), group = Year)) +
