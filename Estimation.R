...
x <- seq(0, 50, by = 0.1)
fitted <- fitdistrplus::fitdist(air_data_median_AQI_2019_wo_pm$median, "gamma")
summary(fitted)
plot(fitted)
fit_1 <- dgamma(x, fitted$estimate[1], fitted$estimate[2])
fitted <- fitdistrplus::fitdist(air_data_median_AQI_2019_wo_pm$median, "exp")
summary(fitted)
plot(fitted)
fit_2 <- dexp(x, fitted$estimate[1])
fitted <- fitdistrplus::fitdist(air_data_median_AQI_2019_wo_pm$median, "lnorm")
summary(fitted)
plot(fitted)
fit_3 <- dlnorm(x, fitted$estimate[1], fitted$estimate[2])
fitted <- fitdistrplus::fitdist(air_data_median_AQI_2019_wo_pm$median, "weibull")
summary(fitted)
plot(fitted)
...
par(mfrow=c(2,2))
plot.legend <- c("gamma", "chisq", "lognormal", "weibull")
fitdistrplus::denscomp(list(fit_1, fit_2, fit_3, fit_4), legendtext = plot.legend)
fitdistrplus::cdfcomp (list(fit_1, fit_2, fit_3, fit_4), legendtext = plot.legend)
fitdistrplus::qqcomp  (list(fit_1, fit_2, fit_3, fit_4), legendtext = plot.legend)
fitdistrplus::ppcomp  (list(fit_1, fit_2, fit_3, fit_4), legendtext = plot.legend)
par(mfrow = c(1,1))
