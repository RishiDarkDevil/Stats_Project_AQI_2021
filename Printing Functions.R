...
full_train_all_cities_pol <- function(data){
  ...
  model_s5 <<- lm(so2 ~ no2 + co + o3 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Lucknow"))
  model_s6 <<- lm(so2 ~ no2 + co + o3 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Patna"))
  model_s7 <<- lm(so2 ~ no2 + co + o3 + pm10 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Chandigarh"))
  model_s8 <<- lm(so2 ~ no2 + co + o3 + pm10 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Gandhinagar"))
  model_s9 <<- lm(so2 ~ no2 + co + o3 + pm10 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Jaipur"))
  ...
  model_n5 <<- lm(no2 ~ so2 + co + o3 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Lucknow"))
  model_n6 <<- lm(no2 ~ so2 + co + o3 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Patna"))
  model_n7 <<- lm(no2 ~ so2 + co + o3 + pm10 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Chandigarh"))
  model_n8 <<- lm(no2 ~ so2 + co + o3 + pm10 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Gandhinagar"))
  model_n9 <<- lm(no2 ~ so2 + co + o3 + pm10 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Jaipur"))
  ...
  model_c5 <<- lm(co ~ so2 + no2 + o3 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Lucknow"))
  model_c6 <<- lm(co ~ so2 + no2 + o3 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Patna"))
  model_c7 <<- lm(co ~ so2 + no2 + o3 + pm10 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Chandigarh"))
  model_c8 <<- lm(co ~ so2 + no2 + o3 + pm10 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Gandhinagar"))
  model_c9 <<- lm(co ~ so2 + no2 + o3 + pm10 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Jaipur"))
  ...
  model_o5 <<- lm(o3 ~ so2 + no2 + co + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Lucknow"))
  model_o6 <<- lm(o3 ~ so2 + no2 + co + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Patna"))
  model_o7 <<- lm(o3 ~ so2 + no2 + co + pm10 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Chandigarh"))
  model_o8 <<- lm(o3 ~ so2 + no2 + co + pm10 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Gandhinagar"))
  model_o9 <<- lm(o3 ~ so2 + no2 + co + pm10 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Jaipur"))
  ...
  #model_p5 <<- lm(pm10 ~ so2 + no2 + co + o3 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Lucknow"))
  #model_p6 <<- lm(pm10 ~ so2 + no2 + co + o3 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Patna"))
  model_p7 <<- lm(pm10 ~ so2 + no2 + co + o3 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Chandigarh"))
  model_p8 <<- lm(pm10 ~ so2 + no2 + co + o3 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Gandhinagar"))
  model_p9 <<- lm(pm10 ~ so2 + no2 + co + o3 + pm25 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Jaipur"))
  ...
  model_p.5 <<- lm(pm25 ~ so2 + no2 + co + o3 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Lucknow"))
  model_p.6 <<- lm(pm25 ~ so2 + no2 + co + o3 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Patna"))
  model_p.7 <<- lm(pm25 ~ so2 + no2 + co + o3 + pm10 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Chandigarh"))
  model_p.8 <<- lm(pm25 ~ so2 + no2 + co + o3 + pm10 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Gandhinagar"))
  model_p.9 <<- lm(pm25 ~ so2 + no2 + co + o3 + pm10 + dew + humidity + pressure + temperature + `wind-speed`, data = data %>% filter(City == "Jaipur"))
}
...
print_all_city_model_summary <- function(){
  model_so2 <- export_summs(model_s1, model_s2, model_s3, model_s4, model_s5, model_s6, model_s7, model_s8, model_s9, error_format = "[{conf.low}, {conf.high}]", model.names = c("Kolkata", "Delhi", "Muzaffarnagar", "Mumbai", "Lucknow", "Patna", "Chandigarh", "Gandhinagar", "Jaipur"))
  model_no2 <- export_summs(model_n1, model_n2, model_n3, model_n4, model_n5, model_n6, model_n7, model_n8, model_n9, error_format = "[{conf.low}, {conf.high}]", model.names = c("Kolkata", "Delhi", "Muzaffarnagar", "Mumbai", "Lucknow", "Patna", "Chandigarh", "Gandhinagar", "Jaipur"))
  model_co <- export_summs(model_c1, model_c2, model_c3, model_c4, model_c5, model_c6, model_c7, model_c8, model_c9, error_format = "[{conf.low}, {conf.high}]", model.names = c("Kolkata", "Delhi", "Muzaffarnagar", "Mumbai", "Lucknow", "Patna", "Chandigarh", "Gandhinagar", "Jaipur"))
  model_o3 <- export_summs(model_o1, model_o2, model_o3, model_o4, model_o5, model_o6, model_o7, model_o8, model_o9, error_format = "[{conf.low}, {conf.high}]", model.names = c("Kolkata", "Delhi", "Muzaffarnagar", "Mumbai", "Lucknow", "Patna", "Chandigarh", "Gandhinagar", "Jaipur"))
  model_pm10 <- export_summs(model_p1, model_p2, model_p3, model_p4, model_p7, model_p8, model_p9, error_format = "[{conf.low}, {conf.high}]", model.names = c("Kolkata", "Delhi", "Muzaffarnagar", "Mumbai", "Chandigarh", "Gandhinagar", "Jaipur"))
  model_pm25 <- export_summs(model_p.1, model_p.2, model_p.3, model_p.4, model_p.5, model_p.6, model_p.7, model_p.8, model_p.9, error_format = "[{conf.low}, {conf.high}]", model.names = c("Kolkata", "Delhi", "Muzaffarnagar", "Mumbai", "Lucknow", "Patna", "Chandigarh", "Gandhinagar", "Jaipur"))
...
print_all_cities_R.squared <- function(data){
  R2.so2 <- tibble(
    ...
    "Lucknow" = find_R.squared(model_s5, data %>% filter(City == "Lucknow")),
    "Patna" = find_R.squared(model_s6, data %>% filter(City == "Patna")),
    "Chandigarh" = find_R.squared(model_s7, data %>% filter(City == "Chandigarh")),
    "Gandhinagar" = find_R.squared(model_s8, data %>% filter(City == "Gandhinagar")),
    "Jaipur" = find_R.squared(model_s9, data %>% filter(City == "Jaipur"))
  )
  R2.no2 <- tibble(
    ...
    "Lucknow" = find_R.squared(model_n5, data %>% filter(City == "Lucknow")),
    "Patna" = find_R.squared(model_n6, data %>% filter(City == "Patna")),
    "Chandigarh" = find_R.squared(model_n7, data %>% filter(City == "Chandigarh")),
    "Gandhinagar" = find_R.squared(model_n8, data %>% filter(City == "Gandhinagar")),
    "Jaipur" = find_R.squared(model_n9, data %>% filter(City == "Jaipur"))
  )
  R2.co <- tibble(
    ...
    "Lucknow" = find_R.squared(model_c5, data %>% filter(City == "Lucknow")),
    "Patna" = find_R.squared(model_c6, data %>% filter(City == "Patna")),
    "Chandigarh" = find_R.squared(model_c7, data %>% filter(City == "Chandigarh")),
    "Gandhinagar" = find_R.squared(model_c8, data %>% filter(City == "Gandhinagar")),
    "Jaipur" = find_R.squared(model_c9, data %>% filter(City == "Jaipur"))
  )
  R2.o3 <- tibble(
    ...
    "Lucknow" = find_R.squared(model_o5, data %>% filter(City == "Lucknow")),
    "Patna" = find_R.squared(model_o6, data %>% filter(City == "Patna")),
    "Chandigarh" = find_R.squared(model_o7, data %>% filter(City == "Chandigarh")),
    "Gandhinagar" = find_R.squared(model_o8, data %>% filter(City == "Gandhinagar")),
    "Jaipur" = find_R.squared(model_o9, data %>% filter(City == "Jaipur"))
  )
  R2.pm10 <- tibble(
    ...
    "Chandigarh" = find_R.squared(model_p7, data %>% filter(City == "Chandigarh")),
    "Gandhinagar" = find_R.squared(model_p8, data %>% filter(City == "Gandhinagar")),
    "Jaipur" = find_R.squared(model_p9, data %>% filter(City == "Jaipur"))
  )
  R2.pm25 <- tibble(
    ...
    "Lucknow" = find_R.squared(model_p.5, data %>% filter(City == "Lucknow")),
    "Patna" = find_R.squared(model_p.6, data %>% filter(City == "Patna")),
    "Chandigarh" = find_R.squared(model_p.7, data %>% filter(City == "Chandigarh")),
    "Gandhinagar" = find_R.squared(model_p.8, data %>% filter(City == "Gandhinagar")),
    "Jaipur" = find_R.squared(model_p.9, data %>% filter(City == "Jaipur"))
  )
...
added_variable_plot_all_cities <- function(data){
  ...
  p1 <- added_variable_plot(data, model_s5, model_n5)
  p2 <- added_variable_plot(data, model_s5, model_c5)
  p3 <- added_variable_plot(data, model_s5, model_o5)
  p5 <- added_variable_plot(data, model_s5, model_p.5)
  r1 <- ggarrange(p1,p2, p3, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_n5, model_s5)
  p2 <- added_variable_plot(data, model_n5, model_c5)
  p3 <- added_variable_plot(data, model_n5, model_o5)
  p5 <- added_variable_plot(data, model_n5, model_p.5)
  r2 <- ggarrange(p1,p2, p3, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_c5, model_s5)
  p2 <- added_variable_plot(data, model_c5, model_n5)
  p3 <- added_variable_plot(data, model_c5, model_o5)
  p5 <- added_variable_plot(data, model_c5, model_p.5)
  r3 <- ggarrange(p1,p2, p3, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_o5, model_s5)
  p2 <- added_variable_plot(data, model_o5, model_c5)
  p3 <- added_variable_plot(data, model_o5, model_n5)
  p5 <- added_variable_plot(data, model_o5, model_p.5)
  r4 <- ggarrange(p1,p2, p3, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_p.5, model_s5)
  p2 <- added_variable_plot(data, model_p.5, model_c5)
  p3 <- added_variable_plot(data, model_p.5, model_n5)
  p4 <- added_variable_plot(data, model_p.5, model_o5)
  r6 <- ggarrange(p1,p2, p3, p4, nrow = 1)
  resid.plot.Lucknow <- ggarrange(r1,r2,r3,r4,r6,nrow = 6) 
  
  p1 <- added_variable_plot(data, model_s6, model_n6)
  p2 <- added_variable_plot(data, model_s6, model_c6)
  p3 <- added_variable_plot(data, model_s6, model_o6)
  p5 <- added_variable_plot(data, model_s6, model_p.6)
  r1 <- ggarrange(p1,p2, p3, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_n6, model_s6)
  p2 <- added_variable_plot(data, model_n6, model_c6)
  p3 <- added_variable_plot(data, model_n6, model_o6)
  p5 <- added_variable_plot(data, model_n6, model_p.6)
  r2 <- ggarrange(p1,p2, p3, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_c6, model_s6)
  p2 <- added_variable_plot(data, model_c6, model_n6)
  p3 <- added_variable_plot(data, model_c6, model_o6)
  p5 <- added_variable_plot(data, model_c6, model_p.6)
  r3 <- ggarrange(p1,p2, p3, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_o6, model_s6)
  p2 <- added_variable_plot(data, model_o6, model_c6)
  p3 <- added_variable_plot(data, model_o6, model_n6)
  p5 <- added_variable_plot(data, model_o6, model_p.6)
  r4 <- ggarrange(p1,p2, p3, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_p.6, model_s6)
  p2 <- added_variable_plot(data, model_p.6, model_c6)
  p3 <- added_variable_plot(data, model_p.6, model_n6)
  p4 <- added_variable_plot(data, model_p.6, model_o6)
  r6 <- ggarrange(p1,p2, p3, p4, nrow = 1)
  resid.plot.Patna <- ggarrange(r1,r2,r3,r4,r6,nrow = 6) 
  
  p1 <- added_variable_plot(data, model_s7, model_n7)
  p2 <- added_variable_plot(data, model_s7, model_c7)
  p3 <- added_variable_plot(data, model_s7, model_o7)
  p4 <- added_variable_plot(data, model_s7, model_p7)
  p5 <- added_variable_plot(data, model_s7, model_p.7)
  r1 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_n7, model_s7)
  p2 <- added_variable_plot(data, model_n7, model_c7)
  p3 <- added_variable_plot(data, model_n7, model_o7)
  p4 <- added_variable_plot(data, model_n7, model_p7)
  p5 <- added_variable_plot(data, model_n7, model_p.7)
  r2 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_c7, model_s7)
  p2 <- added_variable_plot(data, model_c7, model_n7)
  p3 <- added_variable_plot(data, model_c7, model_o7)
  p4 <- added_variable_plot(data, model_c7, model_p7)
  p5 <- added_variable_plot(data, model_c7, model_p.7)
  r3 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_o7, model_s7)
  p2 <- added_variable_plot(data, model_o7, model_c7)
  p3 <- added_variable_plot(data, model_o7, model_n7)
  p4 <- added_variable_plot(data, model_o7, model_p7)
  p5 <- added_variable_plot(data, model_o7, model_p.7)
  r4 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_p7, model_s7)
  p2 <- added_variable_plot(data, model_p7, model_c7)
  p3 <- added_variable_plot(data, model_p7, model_n7)
  p4 <- added_variable_plot(data, model_p7, model_o7)
  p5 <- added_variable_plot(data, model_p7, model_p.7)
  r5 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_p.7, model_s7)
  p2 <- added_variable_plot(data, model_p.7, model_c7)
  p3 <- added_variable_plot(data, model_p.7, model_n7)
  p4 <- added_variable_plot(data, model_p.7, model_o7)
  p5 <- added_variable_plot(data, model_p.7, model_p7)
  r6 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  resid.plot.Chandigarh <- ggarrange(r1,r2,r3,r4,r5,r6,nrow = 6) 
  
  p1 <- added_variable_plot(data, model_s8, model_n8)
  p2 <- added_variable_plot(data, model_s8, model_c8)
  p3 <- added_variable_plot(data, model_s8, model_o8)
  p4 <- added_variable_plot(data, model_s8, model_p8)
  p5 <- added_variable_plot(data, model_s8, model_p.8)
  r1 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_n8, model_s8)
  p2 <- added_variable_plot(data, model_n8, model_c8)
  p3 <- added_variable_plot(data, model_n8, model_o8)
  p4 <- added_variable_plot(data, model_n8, model_p8)
  p5 <- added_variable_plot(data, model_n8, model_p.8)
  r2 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_c8, model_s8)
  p2 <- added_variable_plot(data, model_c8, model_n8)
  p3 <- added_variable_plot(data, model_c8, model_o8)
  p4 <- added_variable_plot(data, model_c8, model_p8)
  p5 <- added_variable_plot(data, model_c8, model_p.8)
  r3 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_o8, model_s8)
  p2 <- added_variable_plot(data, model_o8, model_c8)
  p3 <- added_variable_plot(data, model_o8, model_n8)
  p4 <- added_variable_plot(data, model_o8, model_p8)
  p5 <- added_variable_plot(data, model_o8, model_p.8)
  r4 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_p8, model_s8)
  p2 <- added_variable_plot(data, model_p8, model_c8)
  p3 <- added_variable_plot(data, model_p8, model_n8)
  p4 <- added_variable_plot(data, model_p8, model_o8)
  p5 <- added_variable_plot(data, model_p8, model_p.8)
  r5 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_p.8, model_s8)
  p2 <- added_variable_plot(data, model_p.8, model_c8)
  p3 <- added_variable_plot(data, model_p.8, model_n8)
  p4 <- added_variable_plot(data, model_p.8, model_o8)
  p5 <- added_variable_plot(data, model_p.8, model_p8)
  r6 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  resid.plot.Gandhi <- ggarrange(r1,r2,r3,r4,r5,r6,nrow = 6) 
  
  p1 <- added_variable_plot(data, model_s9, model_n9)
  p2 <- added_variable_plot(data, model_s9, model_c9)
  p3 <- added_variable_plot(data, model_s9, model_o9)
  p4 <- added_variable_plot(data, model_s9, model_p9)
  p5 <- added_variable_plot(data, model_s9, model_p.9)
  r1 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_n9, model_s9)
  p2 <- added_variable_plot(data, model_n9, model_c9)
  p3 <- added_variable_plot(data, model_n9, model_o9)
  p4 <- added_variable_plot(data, model_n9, model_p9)
  p5 <- added_variable_plot(data, model_n9, model_p.9)
  r2 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_c9, model_s9)
  p2 <- added_variable_plot(data, model_c9, model_n9)
  p3 <- added_variable_plot(data, model_c9, model_o9)
  p4 <- added_variable_plot(data, model_c9, model_p9)
  p5 <- added_variable_plot(data, model_c9, model_p.9)
  r3 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_o9, model_s9)
  p2 <- added_variable_plot(data, model_o9, model_c9)
  p3 <- added_variable_plot(data, model_o9, model_n9)
  p4 <- added_variable_plot(data, model_o9, model_p9)
  p5 <- added_variable_plot(data, model_o9, model_p.9)
  r4 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_p9, model_s9)
  p2 <- added_variable_plot(data, model_p9, model_c9)
  p3 <- added_variable_plot(data, model_p9, model_n9)
  p4 <- added_variable_plot(data, model_p9, model_o9)
  p5 <- added_variable_plot(data, model_p9, model_p.9)
  r5 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  p1 <- added_variable_plot(data, model_p.9, model_s9)
  p2 <- added_variable_plot(data, model_p.9, model_c9)
  p3 <- added_variable_plot(data, model_p.9, model_n9)
  p4 <- added_variable_plot(data, model_p.9, model_o9)
  p5 <- added_variable_plot(data, model_p.9, model_p9)
  r6 <- ggarrange(p1,p2, p3, p4, p5, nrow = 1)
  resid.plot.Jaipur <- ggarrange(r1,r2,r3,r4,r5,r6,nrow = 6) 
  
  return(list("resid.plot.Kolkata" = resid.plot.Kolkata, "resid.plot.Delhi"=resid.plot.Delhi, "resid.plot.Muzz"=resid.plot.Muzz, "resid.plot.Mumbai"=resid.plot.Mumbai, "resid.plot.Lucknow"=resid.plot.Lucknow, "resid.plot.Patna"=resid.plot.Patna, "resid.plot.Chandigarh"=resid.plot.Chandigarh, "resid.plot.Gandhi"=resid.plot.Gandhi,"resid.plot.Jaipur"=resid.plot.Jaipur))
}
